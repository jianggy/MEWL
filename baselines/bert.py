...
import numpy as np
import torch
from dataset import get_MEWL_huggingface
...
def main():
    ...
    if data_args.train_file is not None:
        raw_datasets = get_MEWL_huggingface(
    ...
    def preprocess_function(examples):
        questions = examples["start_phrase"]
        tgt_sentences = examples["choices"]

        # Flatten out
        questions = [[question] * 5 for question in questions]

        questions = sum(questions, [])
        tgt_sentences = sum(tgt_sentences, [])
